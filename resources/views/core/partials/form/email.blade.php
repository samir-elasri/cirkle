    ...
    <div class='field-body'>
		<div class='field'>
			<div class='control has-icons-left'>
                <input {{ !empty($errorMessage) ? "aria-describedby='error-" . $name . "'" : '' }} {{ !empty($requiredString) ? 'aria-required="true"' : '' }} id="{{ $name }}" value='{{$value}}' class='input mask-is-email {{$errorClass}}' type='email' placeholder='' name='{{$name}}'>
